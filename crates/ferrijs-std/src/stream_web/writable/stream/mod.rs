...
impl<'js> WritableStream<'js> {
    ...
    pub(crate) fn create_for_transform(
        ...
        ts_stream: crate::stream_web::transform::stream::TransformStreamClass<'js>,
        ts_controller: crate::stream_web::transform::controller::TransformStreamDefaultControllerClass<'js>,
        high_water_mark: f64,
        size_algorithm: crate::stream_web::queuing_strategy::SizeAlgorithm<'js>,
