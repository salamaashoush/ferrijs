    ...
    pub(crate) fn call(
        ...
        match self {
            ...
            PullAlgorithm::Tee(state) => {
                crate::stream_web::readable::stream::tee::tee_pull_algorithm(ctx, state.clone())
            },
    ...
    pub(crate) fn call(
        ...
        match self {
            ...
            CancelAlgorithm::Tee1(state) => {
                crate::stream_web::readable::stream::tee::tee_cancel_algorithm(ctx, state.clone(), reason, 0)
            },
            CancelAlgorithm::Tee2(state) => {
                crate::stream_web::readable::stream::tee::tee_cancel_algorithm(ctx, state.clone(), reason, 1)
            },
