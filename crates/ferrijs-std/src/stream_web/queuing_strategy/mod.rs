...
use crate::stream_web::utils::ValueOrUndefined;
...
pub(crate) enum SizeAlgorithm<'js> {
    AlwaysOne,
...
#[derive(JsLifetime, Trace, Clone)]
pub(crate) enum SizeFunction<'js> {
    Js(Function<'js>),
...
pub(crate) enum NativeSizeFunction {
    ByteLength,
    Count,
}
